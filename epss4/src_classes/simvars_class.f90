...
module simvars_class
    ...
    type tSimvars
        ...
        real(dp), dimension(:), allocatable ::    &
                ...
                net_mpk, r, rf, r_pf, r_pf_median, r_pf_kappa_med, wage, trans, pens, tau, welf, bequests, & ! prices
    ...
    contains
        ...
        generic   :: get => get_real ! can't overoad function call with get_integer
        procedure :: cons_grow
        procedure :: zeta
        procedure :: delta
        procedure :: K_Y
...
contains
    elemental subroutine allocate_simvars(this,t)
        ...
        allocate(this%net_mpk(t),this%r(t),this%rf(t+1), this%r_pf(t), this%r_pf_median(t), this%r_pf_kappa_med(t), this%wage(t), this%trans(t), this%pens(t), this%tau(t), this%bequests(t))
    ...
    elemental subroutine deallocate_simvars(this)
        ...
        if (allocated(this%dyn_eff_a)) deallocate(this%dyn_eff_a)
        if (allocated(this%dyn_eff_b)) deallocate(this%dyn_eff_b)
        ...
        if (allocated(this%trans)) deallocate(this%trans)
    ...
    pure function get_logical(this,varname, lb_o, ub_o) result(get)
        ...
        case ('dyn_eff_a')
            get = this%dyn_eff_a(lb:ub)
        end select

    end function get_logical

    pure function get_integer(this,varname, lb_o, ub_o) result(get)
        integer ,allocatable,dimension(:)         :: get
        class(tSimvars)  ,intent(in)  :: this
        character(len=*) ,intent(in)  :: varname
        integer, intent(in) ,optional :: lb_o, ub_o ! lower bound, upper bound
        integer :: lb, ub
